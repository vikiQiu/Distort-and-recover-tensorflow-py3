...
def model_vgg(data, model_path):
	with tf.device("/gpu:0"):
		...
		conv1_1_weights = tf.Variable(imported_weight['conv1_1_W'], name='conv1_1_weights')
		conv1_1_biases  = tf.Variable(imported_weight['conv1_1_b'], name='conv1_1_biases')
		conv1_2_weights = tf.Variable(imported_weight['conv1_2_W'], name='conv1_2_weights')
		conv1_2_biases  = tf.Variable(imported_weight['conv1_2_b'], name='conv1_2_biases')
		...
		conv2_1_weights = tf.Variable(imported_weight['conv2_1_W'], name='conv2_1_weights')
		conv2_1_biases  = tf.Variable(imported_weight['conv2_1_b'], name='conv2_1_biases')
		conv2_2_weights = tf.Variable(imported_weight['conv2_2_W'], name='conv2_2_weights')
		conv2_2_biases  = tf.Variable(imported_weight['conv2_2_b'], name='conv2_2_biases')
		...
		conv3_1_weights = tf.Variable(imported_weight['conv3_1_W'], name='conv3_1_weights')
		conv3_1_biases  = tf.Variable(imported_weight['conv3_1_b'], name='conv3_1_biases')
		conv3_2_weights = tf.Variable(imported_weight['conv3_2_W'], name='conv3_2_weights')
		conv3_2_biases  = tf.Variable(imported_weight['conv3_2_b'], name='conv3_2_biases')
		conv3_3_weights = tf.Variable(imported_weight['conv3_3_W'], name='conv3_3_weights')
		conv3_3_biases  = tf.Variable(imported_weight['conv3_3_b'], name='conv3_3_biases')
		...
		conv4_1_weights = tf.Variable(imported_weight['conv4_1_W'], name='conv4_1_weights')
		conv4_1_biases  = tf.Variable(imported_weight['conv4_1_b'], name='conv4_1_biases')
		conv4_2_weights = tf.Variable(imported_weight['conv4_2_W'], name='conv4_2_weights')
		conv4_2_biases  = tf.Variable(imported_weight['conv4_2_b'], name='conv4_2_biases')
		conv4_3_weights = tf.Variable(imported_weight['conv4_3_W'], name='conv4_3_weights')
		conv4_3_biases  = tf.Variable(imported_weight['conv4_3_b'], name='conv4_3_biases')
		...
		conv5_1_weights = tf.Variable(imported_weight['conv5_1_W'], name='conv5_1_weights')
		conv5_1_biases  = tf.Variable(imported_weight['conv5_1_b'], name='conv5_1_biases')
		conv5_2_weights = tf.Variable(imported_weight['conv5_2_W'], name='conv5_2_weights')
		conv5_2_biases  = tf.Variable(imported_weight['conv5_2_b'], name='conv5_2_biases')
		conv5_3_weights = tf.Variable(imported_weight['conv5_3_W'], name='conv5_3_weights')
		conv5_3_biases  = tf.Variable(imported_weight['conv5_3_b'], name='conv5_3_biases')
		...
		fc6_weights = tf.Variable(imported_weight['fc6_W'], name='fc6_weights')
		fc6_biases 	= tf.Variable(imported_weight['fc6_b'], name='fc6_biases')
